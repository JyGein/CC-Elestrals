...
public interface IDynaCharge
{
	...
	void Render(G g, State state, Combat combat, Ship ship, int worldX, Vec position) => Elestrals.Instance.DuoApis.dynaApi?.DefaultRenderChargeImplementation(this, g, state, combat, ship, worldX, position);
